...
using API_CatalogandoJogos.Services;
...
namespace API_CatalogandoJogos.Controllers.V1
{
    ...
    public class JogosController : ControllerBase
    {
        ...
        [HttpGet("{idJogo:guid}")]
        public async Task<ActionResult<JogoViewModel>> ObterPoId([FromRoute] Guid idJogo)
        {
        ...
        [HttpPost]
        public async Task<ActionResult<JogoViewModel>> PostarJogo([FromBody] JogoInputModel jogoInputModel)
        {
            try
            {
                var jogo = await _jogoService.PostarJogo(jogoInputModel);
